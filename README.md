...
server-side. For local development, you can place the key in a `.env` file; on Vercel, set the
environment variable in the dashboard.

1. Create a `.env` file in the project root or set the API key in your shell:
